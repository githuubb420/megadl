...
async def start(bot, message, cb=False):
    ...
    if cb:
        await message.message.edit(
            text=TEXT.START_TEXT.format(user_mention=message.from_user.mention, bot_name=me.mention(
    ...
    if Config.UPDATES_CHANNEL:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.message.edit(
                    text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await message.message.edit(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                "🔄 Refresh 🔄", callback_data="refreshmeh")
                        ]
                    ]
                ),
                parse_mode="markdown"
